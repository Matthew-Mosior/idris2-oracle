...
prim__timestampNanosecond : AnyPtr -> PrimIO Int
...
prim__timestampTZHour : AnyPtr -> PrimIO Int
...
prim__timestampTZMinute : AnyPtr -> PrimIO Int
...
prim__intervalDSNanoseconds : AnyPtr -> PrimIO Int
